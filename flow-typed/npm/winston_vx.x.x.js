// flow-typed signature: 2d1662e470ec381d385b347430834645
// flow-typed version: <<STUB>>/winston_v~2.4.0/flow_v0.57.2

declare interface IWinstonLevels {
  error: number,
  warn: number,
  info: number,
  verbose: number,
...
declare interface IWinstonColors {
  error: string,
  warn: string,
  info: string,
  verbose: string,
...
declare interface IConsoleParams {
  level: string,
  colorize: boolean,
  stderrLevels: Array<string>
}

declare interface ILoggerParams {
  transports: any
}
...
declare module 'winston' {
  declare module.exports: {
    // transports: {
    //   Console: {
    //     get: (O: IConsoleParams) => void
    //   }
    // },
    // Logger: {
    //   get: (O: ILoggerParams) => () => void
    // }
    setLevels(O: IWinstonLevels): void,
    addColors(O: IWinstonColors): void,
